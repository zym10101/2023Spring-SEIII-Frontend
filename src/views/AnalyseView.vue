    ...
    <el-form class="datefrom" ref="form" :model="form" label-width="20%">
      <el-row>
        ...
        <div v-if="selectedPie == 'option1'" class="weighting">
            ...
            <input type="number" class="inputbox" id="pieAll" v-model="weightingPieAll" placeholder="0~1" @input="checkRange1" @change="drawAllByWeighting" min="0" max="1" step="0.1">
        </div>
        ...
        <div v-if="selectedLine == 'option1'" class="weighting">
            <label class="placeholder" style="font-size: 16px">请选择issue权重：</label>
            <input type="number" class="inputbox" id="lineAll" v-model="weightingLineAll" placeholder="0~1" @input="checkRange2" @change="drawAllByWeighting" min="0" max="1" step="0.1">
        </div>
    ...
    <div style="margin-top: 16px;margin-bottom: 5px">
      ...
      <div class="options">
        ...
        <div v-if="selectedLalel == 'option1'" class="weighting">
            <label class="placeholder" style="font-size: 16px">请选择issue权重：</label>
            <input type="number" class="inputbox" id="labelAll" v-model="weightingLabelAll" placeholder="0~1" @input="checkRange3" @change="drawAllByWeighting" min="0" max="1" step="0.1">
        </div>
...
<!--        reaction-->
        ...
        <div v-if="selectedLineReaction == 'option1'" class="weighting">
            <label class="placeholder" style="font-size: 16px">请选择issue权重：</label>
            <input type="number" class="inputbox" id="reactionAll" v-model="weightingReactionAll" placeholder="0~1" @input="checkRange4" @change="drawAllByWeighting" min="0" max="1" step="0.1">
        </div>
    ...
    <div>
          ...
          <div v-if="selectedLineUser == 'option1'" class="weighting">
            <label class="placeholder" style="font-size: 16px">请选择issue权重：</label>
            <input type="number" class="inputbox" id="UserAll" v-model="weightingUserAll" placeholder="0~1" @input="checkRange5" @change="drawAllByWeighting" min="0" max="1" step="0.1">
          </div>

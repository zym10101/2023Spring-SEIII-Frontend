            ...
            <div class="wrapper__box">
                ...
                <div class="wrapper__box__body">
                    <el-form v-if="isLoginForm" :model="loginForm" @submit.prevent="login" style="margin-top: 30px">
                        ...
                        <input v-model="loginForm.username" type="text" placeholder="enter your username or email" v-validator="usernameOption" />
                        <p v-if="usernameBlank && isBlankUser" class="errorText">用户名不能为空</p>

                        <p class="input_title">password</p>
                        <input v-model="loginForm.password" type="password" placeholder="enter your username" v-validator="passwordOption" />
                        ...
                        <div class="verification-code">
                            ...
                            <button :disabled="isCounting" @click="toggleForm">{{ isLoginForm? '没有账号，立即注册' : '返回登录' }}</button>
                        </div>
                    </el-form>
                    ...
                    <el-form v-else :model="registerForm" @submit.prevent="register" >
                        ...
                        <div class="verification-code">
                            ...
                            <button :disabled="isCounting" @click="toggleForm" class="changeButton"  >{{ isLoginForm? '没有账号，立即注册' : '已有账号，返回登录' }}</button>
                        </div>
                    </el-form>
